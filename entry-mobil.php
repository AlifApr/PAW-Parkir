  ...
  <body>
    ...
    <?php }if($_SESSION['level'] == 'kp1' || $_SESSION['level'] == 'kp2'){?>
      ...
      <label for="waktu_masuk">Waktu Masuk Parkir</label>
        <input type="text" id="waktu_masuk" name="waktu_masuk" placeholder="Waktu Masuk Parkir" value="<?php date_default_timezone_set('Asia/Jakarta');$tgl=date('Y-m-d h:i:s'); echo $tgl;?>">
